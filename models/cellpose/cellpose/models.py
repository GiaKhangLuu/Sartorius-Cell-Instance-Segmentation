...
class CellposeModel(UnetModel):
    ...
    def train(self, train_data, train_labels, train_files=None, 
        ...
        model_path, epochs, loss_vls, val_loss_vls = self._train_net(train_data, train_flows, 
        ...
        return model_path, epochs, loss_vls, val_loss_vls
    ...
    def train(self, train_data, train_labels,
        ...
        """ train size model with images train_data to estimate linear model from styles to diameters
            ...
            batch_size: int (optional, default 8)
                ...
                (can make smaller or bigger depending on GPU memory usage)
        """
        epochs, train_corr_vls, val_corr_vls = [], [], []
        ...
        for iepoch in range(n_epochs):
            ...
            if (iepoch+1)%2==0:
                ...
                train_corr_vls.append(np.corrcoef(y, ypred)[0,1])
                ...
                if run_test:
                    ...
                    val_corr_vls.append(np.corrcoef(diam_test, diam_test_pred)[0,1])
        ...
        return self.params, epochs, train_corr_vls, val_corr_vls
